...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmap/grid-points \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN" \\\n    -d \'{\n          "grid_radius": 3495,\n          "grid_size": 3,\n          "lat": 44.670381143996,\n          "lng": -88.122418774951,\n          "polygon": {}\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmaps/$HEATMAP_ID/points/$POINT_ID \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmaps \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmaps/locations \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmaps/$HEATMAP \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmaps/$HEATMAP/competitors \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmap/schedules \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmap/schedules/$SCHEDULE \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmap/schedules/$SCHEDULE_ID \\\n    -X PATCH \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN" \\\n    -d \'{\n          "heatmap_config": {\n            "name": "Weekly Roofing Check Updated",\n            "place_id": 12\n          },\n          "schedule_config": {\n            "repeat_type": "month"\n          }\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmap/schedules/$SCHEDULE_ID/pause \\\n    -X POST \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://staging.crmthrive.com/public/api/v1/heatmap/schedules/$SCHEDULE_ID/resume \\\n    -X POST \\\n    -H "Authorization: Bearer $THRIVE_MCP_BEARER_TOKEN"',
      },
    },
  },
];
