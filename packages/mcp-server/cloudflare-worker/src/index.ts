...
import { ClientOptions } from 'thrive-mcp';
import { McpOptions } from 'thrive-mcp-mcp/options';
import { initMcpServer, newMcpServer } from 'thrive-mcp-mcp/server';
import { configureLogger } from 'thrive-mcp-mcp/logger';
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'thrive_mcp_api', version: '0.4.0' },
